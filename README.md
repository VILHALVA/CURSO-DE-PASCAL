...
1. **Desenvolvimento Inicial (1968-1970)**:
...
2. **Lançamento da Linguagem (1970)**:
...
3. **Popularização e Uso Educacional (1970-1980)**:
...
4. **Padronização e Evolução (1970-1980)**:
...
5. **Influência e Legado (1980-Atualmente)**:
